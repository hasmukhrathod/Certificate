class MigrationsController < ApplicationController
  ...
  def show
	respond_to do |format|
    		format.html
    		format.pdf do
      			render pdf: @migration.lastName,         # file name
  ...
  private
    ...
    def migration_params
      params.require(:migration).permit(:lastName, :firstName, :middleName, :joinedDate, :leftDate, :passExam, :dateExam, :duePaidDate, :todayDate, :enteredBy, :checkedBy)
    end
end
